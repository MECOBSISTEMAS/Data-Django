...
urlpatterns = [
    ...
    path('aprovar-credito/<credito_id>', views_fix_repasse.aprovar_credito, name='aprovar_credito'),
    path('desaprovar-credito/<credito_id>', views_fix_repasse.desaprovar_credito, name='desaprovar_credito'),
    path('aprovar-debito/<debito_id>', views_fix_repasse.aprovar_debito, name='aprovar_debito'),
    path('desaprovar-debito/<debito_id>', views_fix_repasse.desaprovar_debito, name='desaprovar_debito'),
    # Matches any html file
